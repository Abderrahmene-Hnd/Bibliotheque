            ...
            <div style="min-height: 1000px"
                ...
                <div class="px-5">
                    ...
                    <ul class="mt-12">
                        ...
                        <li
                            class="flex w-full justify-between  hover:text-gray-300 {{ $_SERVER['REQUEST_URI']=='/dashboard/author'? 'text-gray-100' : 'text-gray-400'}} cursor-pointer items-center mb-6">
